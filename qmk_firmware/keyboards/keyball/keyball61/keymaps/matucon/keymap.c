...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_PDOT  , KC_P1    , KC_P2     , KC_P3    , KC_PEQL , S(KC_8)  ,             S(KC_9)  , _______  , KC_BTN4  , SCRL_TO  , KC_BTN5  , KC_F5    , PRC_SW   ,
    KC_NUM   , KC_PCMM  , KC_P0    , KC_PENT   , _______  , _______ , _______  ,             KC_SPC   , _______  , _______  , _______  , _______  , _______  , KC_TRNS
  ),
